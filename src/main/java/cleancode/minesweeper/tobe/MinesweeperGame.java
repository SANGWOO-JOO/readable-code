...
public class MinesweeperGame {
    ...
    public static final int LAND_MIE_COUNT = 10;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String input = getCellInputFromUser();
            String userActionInput = getUserActionInputFromUser();
            actOnCell(input, userActionInput);
        }
    }

    private static void actOnCell(String input, String userActionInput) {
        int selectedColIndex = getSelectedColIndex(input);
        int selectedRowIndex = getSelectedRowIndex(input);
        if (doseUserChooseToPlanFlag(userActionInput)) {
    ...
    private static boolean doseUserChooseToPlanFlag(String userActionInput) {
    ...
    private static void showBoard() {
        System.out.println("   a b cellInpulCol d e f g h i j");
    ...
    private static void initializeGame() {
        ...
        for (int i = 0; i < LAND_MIE_COUNT; i++) {
